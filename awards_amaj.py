...
class test_imdb_menu(unittest.TestCase):
    ...
    def test_003_menu_Golden_Globes(self):
        ...
        self.assertEqual(self.driver.find_element_by_xpath("//h1[normalize-space()='GOLDEN GLOBES']").text,
                         "GOLDEN GLOBES", msg="Not GOLDEN GLOBES")
        #        self.driver.get_screenshot_as_file("Golden Globes" + ".png")
